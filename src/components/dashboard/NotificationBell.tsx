import { Bell, Plus, CalendarCheck, UserX, MessageSquare, AlertTriangle, Clock, BellRing, UserPlus, CalendarIcon } from "lucide-react";
...
function getRemindUrgency(remind_at?: string | null): "overdue" | "soon" | null {
  ...
  if (diff < 2 * 60 * 60 * 1000) return "soon"; // within 2 hours
  return null;
}
...
export function NotificationBell() {
  ...
  // Sort: overdue first, then soon, then others
      ...
      <PopoverContent align="end" className="w-96 p-0 rounded-2xl shadow-elevated border-border/60">
        ...
        <div className="max-h-[360px] overflow-y-auto scrollbar-thin divide-y divide-border/40">
          {sortedNotifications.length === 0 ? (
            ...
            sortedNotifications.slice(0, 25).map((n) => {
