...
const PLANS: Plan[] = [
  ...
  },
  {
    ...
    features: [
      ...
      { text: "7/24 Sesli AI Resepsiyonist (Aylık 500 Dk. Kota)", included: true },
      { text: "VIP Hizmet: Doktorun Kendi Sesiyle Ses Klonlama", included: true },
      ...
      { text: "Video Stüdyo: AI Klon Dublaj & Dudak Senkronizasyonu (Lip-Sync)", included: true },
