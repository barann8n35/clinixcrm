      ...
      >
        ...
        <div className="relative w-full sm:w-72">
          ...
          <Input
            ...
            className="pl-9 h-10 text-sm rounded-xl border-border/60 bg-card shadow-card focus:shadow-elevated transition-shadow"
          />
        </div>
      </motion.div>
        ...
        >
          ...
          <div className="text-center">
            ...
            <p className="text-xs text-muted-foreground/60 mt-1">
              {search ? "Farklı bir arama terimi deneyin" : "İlk hastanız eklendiğinde burada görünecek"}
            </p>
          </div>
        </motion.div>
      )}
        ...
        <div className="grid gap-3">
          {filtered.map((patient, i) => (
            <motion.div
              ...
              className="rounded-2xl border border-border/60 bg-card p-4 flex items-start gap-4 shadow-card card-interactive cursor-pointer"
            >
